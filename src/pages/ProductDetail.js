        ...
        <section>
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="max-w-xl my-3">
              ...
              <p className="my-3">
              {!inCart&&<button useState={useState} onClick={()=>addToCart(product)} className={`inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 ${product.in_stock?"":"cursor-not-allowed  disabled:true" }`} disabled={product.in_stock? "":"disabled"}

...
export const Register = () => {
  ...
  async function handleRegister(event){
    ...
    const response = await fetch(`${process.env.REACT_APP_HOST}http://localhost:8000/register`, requestOptions);
